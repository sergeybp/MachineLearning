...
public enum Distances {
 ...
 //   PEARSON("PEARSON");
    ...
    //        case COSINE_SIMILARITY:
      //          return (a, b) -> IntStream.range(0, a.n).mapToDouble(i -> a.get(i) * b.get(i)).sum() /
        //                (sqrt(IntStream.range(0, a.n).mapToDouble(i -> a.get(i) * a.get(i)).sum()) * sqrt(IntStream.range(0, a.n).mapToDouble(i -> b.get(i) * b.get(i)).sum()));
            case CHEBYSHEV:
